...
import type { HomePageContent, Locale } from "./content";
...
export default function HomePageClient({ featuredProducts, productHierarchy, verificationIndex, siteContent }: HomePageClientProps) {
  const { faqs, solutions, trustProof } = siteContent;
  ...
  return (
    <main id="top" className={isArabic ? "arabic" : ""}>
      ...
      <ProductFinder locale={locale} products={featuredProducts} previewLimit={4} verificationIndex={verificationIndex} />
